...
const currencySchema = new mongoose.Schema({
    currencyCode: String,
    rate: { type: String, required: true }, //обязательное поле
    date: Date,
  });

const Currency = mongoose.model('Currency', currencySchema);

// Расписание для синхронизации данных чешской кроны
// Синхронизация происходит каждый день в 00
cron.schedule('0 1 * * *', async () => {
  console.log('Выполнение инхронизации данных чешской кроны...');
  await syncData();
});

// Функция выполнения синхронизации данных
...
// Синхронизация данных за оперделенный период времени 
...
// Составление отчета курсов чешкой кроны за определенный период времени 
